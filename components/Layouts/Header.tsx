...
const Header = () => {
    ...
    // message type => 
    /*
     {id : number , image : string  , title : string  , message : string , time , string}[]
    */
    interface messageType  {id : number , image : string , title : string , message : string  , time :string  } 
    interface notificationType  {id : number , profile : string , message : string  , time :string  } 
